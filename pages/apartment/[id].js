...
//   // ============================================================
//   // ⭐ ИСПРАВЛЕНИЕ 1: УЛУЧШЕННЫЕ СТРУКТУРИРОВАННЫЕ ДАННЫЕ
//   // ============================================================
//   const structuredData = {
//     '@context': 'https://schema.org',
//     '@type': 'RentalProperty',
//     name: apartment?.objectName || apartment?.name,
//     description: apartment?.description,
//     image: apartment?.photos?.[0] || undefined,
//     url: `https://nadoby.com.ua/apartment/${apartment?._id}/`,
...
//   // ============================================================
//   // ⭐ ИСПРАВЛЕНИЕ 2: ПОЛНЫЙ НАБОР SEO-ТЕГОВ В HEAD
//   // ============================================================
//   const pageUrl = `https://nadoby.com.ua/apartment/${apartment._id}/`;
//   const pageTitle = `${apartment.objectName || apartment.name} | NaDoby`;
//   const pageDescription = apartment.description?.substring(0, 160) || "Аренда жилья в Киеве и Украине";
//   const pageImage = apartment?.photos?.[0] || 'https://nadoby.com.ua/og-image.jpg';
...
//         {/* ⭐ ИСПРАВЛЕНИЕ 3: CANONICAL URL */}
//         <link rel="canonical" href={pageUrl} />
        
//         {/* ⭐ ИСПРАВЛЕНИЕ 4: META ROBOTS (индексация разрешена) */}
//         <meta name="robots" content="index, follow" />
        
//         {/* ⭐ ИСПРАВЛЕНИЕ 5: OPEN GRAPH для соцсетей */}
...
//         {/* ============================================================
//             ⭐ ИСПРАВЛЕНИЕ 7: H1 ЗАГОЛОВОК (было Typography без component="h1")
//             ============================================================ */}
//         <Box mb={2}>
//           <Typography 
//             component="h1"  // <-- ГЛАВНОЕ ИЗМЕНЕНИЕ: теперь это H1
...
const ApartmentDetailContent = memo(({ apartmentData, userApartmentsCount }) => {
  ...
  // ============================================================
  // ⭐ ИСПРАВЛЕНИЕ: isMobile через useState + useEffect
  // ============================================================
  ...
  // ============================================================
  // ⭐ ИСПРАВЛЕНИЕ: localStorage с проверкой window
  // ============================================================
  const handleToggleFavorite = useCallback(async () => {
  ...
  return (
    <>
      ...
      <Box maxWidth="1200px" mx="auto" px={{ xs: 0, sm: 3 }} marginTop={5}>
        ...
        {/* ============================================================
            ⭐ СЛАЙДЕР ФОТО ОБЕРНУТ В ClientOnly
            ============================================================ */}
        <ClientOnly fallback={<Box sx={{ height: 400, bgcolor: '#f5f5f5', borderRadius: 2 }} />}>
          <FileUploadSlider
            photos={apartment.photos}
            price={apartment.price}
            name={apartment.name}
