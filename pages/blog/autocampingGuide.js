...
function AutocampingGuide({ generatedAt }) {
  ...
  // ============================================================
  // ⭐ ДОБАВЛЕНЫ ПЕРЕМЕННЫЕ ДЛЯ SEO
  // ============================================================
  const pageUrl = 'https://nadoby.com.ua/blog/autocampingGuide'
  const pageTitle = t.title
  const pageDescription = t.metaDescription
  const pageImage = 'https://nadoby.com.ua/avtokemping.png'
  ...
  return (
    <>
      <Head>
        ...
        {/* ⭐ Meta Robots (индексация разрешена) */}
