...
import { Box, Typography, Container, Card, CardContent, Button, Chip, CircularProgress } from '@mui/material'
import Image from 'next/image'
import Link from 'next/link'
import Head from 'next/head'
import Footer from "@/app/components/Footer"
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://nadoby.com.ua/blog" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="NaDoby" />
        <meta property="og:image" content="https://nadoby.com.ua/og-image.jpg" />
        ...
        <meta name="twitter:image" content="https://nadoby.com.ua/og-image.jpg" />
      </Head>
...
function Blog({ generatedAt }) {
  return (
    <>
      <Head>
        {/* Этот Head нужен для базовых тегов, которые не зависят от контента */}
        <meta charSet="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>
      <Header />
      {/* ⭐ ОБЕРТАЕМ ВЕСЬ КОНТЕНТ В ClientOnly */}
      <ClientOnly fallback={
