...
//   useMediaQuery
// } from "@mui/material";
// import { Close, ArrowDropDown, Calculate, ContentCopy, Email, Mail } from "@mui/icons-material";
...
//     language: "Мова",
//     currency: "Валюта",
//     listProperty: "Розмістити оголошення безкоштовно",
//     search: "Пошук житла",
...
//     language: "Язык",
//     currency: "Валюта",
//     listProperty: "Разместить объявление бесплатно",
//     search: "Поиск жилья",
...
//   // Функция для связи с поддержкой - ИСПРАВЛЕНО: предотвращаем закрытие меню
...
//   useEffect(() => {
//     if (isMenuOpen || openAuthModal || showEmailDialog) {
//       document.addEventListener('mousedown', handleClickOutside);
//       return () => document.removeEventListener('mousedown', handleClickOutside);
//     }
//   }, [isMenuOpen, openAuthModal, showEmailDialog, handleClickOutside]);
...
//   if (!isMenuOpen && !openAuthModal && !showEmailDialog) return null;
...
//     <>
//       {/* Затемненный фон */}
//       {(isMenuOpen || openAuthModal || showEmailDialog) && (
//         <Box
//           sx={{
//             position: 'fixed',
//             top: 0,
...
// // ============================================
// // FastLink - компонент для быстрых ссылок с предзагрузкой
// // ============================================
// const FastLink = memo(React.forwardRef(({ href, children, onClick, ...props }, ref) => {
//   const router = useRouter();
...
//   // ============================================
//   // Функция для получения курсов валют (загружается 1 раз)
//   // ============================================
//   const fetchExchangeRates = useCallback(async () => {
...
//   // ============================================
//   // ЗАГРУЗКА КУРСОВ ВАЛЮТ ТОЛЬКО 1 РАЗ ПРИ МОНТИРОВАНИИ
//   // ============================================
//   useEffect(() => {
//     fetchExchangeRates();
//   }, []);
...
//   // ============================================
//   // ДОПОЛНИТЕЛЬНАЯ ПРЕДЗАГРУЗКА ДЛЯ МОБИЛКИ
//   // ============================================
//   useEffect(() => {
//     if (isMobile) {
//       const mobilePages = [
...
//   // ============================================
//   // ОБРАБОТКА КЛИКОВ ВНЕ МЕНЮ - ИСПРАВЛЕНО!
//   // ============================================
//   const handleClickOutside = useCallback((e) => {
//     // Проверяем, что клик был вне меню
//     const isOutsideMenu = menuRef.current && !menuRef.current.contains(e.target);
...
//     const isMenuButton = e.target.closest('.menuWrapper') || e.target.closest('[class*="menuWrapper"]');
    
//     // Закрываем всё, если клик был вне всех элементов
//     if (isOutsideMenu && !isMenuButton && isOutsideAuthModal && isOutsideEmailDialog) {
//       setOpenLanguage(false);
//       setOpenCurrency(false);
//       setOpenAuthModal(false);
//       setShowAlert(false);
//       setShowEmailDialog(false);
//       onClose?.(); // <-- Закрываем меню через Header
//     }
//   }, [onClose]);

//   // ============================================
//   // Включаем обработчик кликов вне меню
//   // ============================================
//   useEffect(() => {
//     document.addEventListener('mousedown', handleClickOutside);
//     return () => document.removeEventListener('mousedown', handleClickOutside);
